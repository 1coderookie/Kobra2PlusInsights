...
### Check The Belts
Make sure the belts of the axes are properly tensioned. Don't go with sloppy belts, but don't tension them up too much as well.  
Make sure that the two belts at the Y-axis are tensioned *equally*.  
Please refer to the according sections for further information.  
