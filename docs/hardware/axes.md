...
| **Z-Axis Lead Screws**: T8x8 (8mm diameter, 8mm lead, 2mm pitch, 4 starts), 500-505(??)mm length, 10mm and ~23mm unthreaded 5mm OD shaft, belt-driven dual z  |
| **Z-Axis Timing Belt**: GT-2, 6mm width, closed loop, length 810mm |
...
### Timing Belt  
The two lead screws are connected by a closed loop GT-2 timing belt (6mm width, 810mm length).    
...
The following pictures shows a motor with the mounting bracket.  
